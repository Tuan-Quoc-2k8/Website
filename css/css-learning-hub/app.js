...
function updateLanguage() {
    var elements = {
        ...
        settingsModalTitle: 'settingsTitle',
        languageLabel: 'languageLabel',
        themeLabel: 'themeLabel',
        themeLightText: 'themeLight',
        themeDarkText: 'themeDark',
        footerText: 'footerText',
        compatWarningText: 'compatWarning',
        compatWarningBtn: 'compatWarningBtn'
    };

    for (var key in elements) {
        var el = document.getElementById(elements[key]);
